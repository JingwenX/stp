create or replace PACKAGE BODY                                                                                                                                                                                                             STP_CP_UTIL_PKG AS
    ...
    /*
    /* @description: truncate the collection and load contract detail data into collection with
    /*               name DETAIL_COLLECTION_NAME.
    /*
    /* @type P_CONTRACT_ITEM_ID In Number - Contract item id.
    /************************************************************************************************/ 
    ...
    /*
    /* @description: procedure for manipulation of contract detail items.
    /*
    /* @note: a) the procedure loads page items, in case of changing the table and page layout, this
    /*           procedure might throw errors.
    /*        b) this procedure only manipulates collection, but not pushs anything to the database. 
    /************************************************************************************************/ 
    PROCEDURE create_or_save_detail_row
    AS
    ...
    BEGIN
        ...
        IF l_seq_id is NULL then
            -- Add new if sequence id does not exist.
            APEX_COLLECTION.ADD_MEMBER (
                p_collection_name => DETAIL_COLLECTION_NAME,
                p_c001 => l_type,
                p_c002 => l_stock_type,
    ...
    /*
    /* @description: process and pushes contract_item data back into database.
    /*
    /* @type p_contract_item_id In Number - the item id of the contract item
    /************************************************************************************************/ 
